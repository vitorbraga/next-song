const SONG_STYLES_DROPDOWN = [
  ...
  { label: 'TH Housy', value: 'TH Housy' },
  { label: 'TH Ethnic', value: 'TH Ethnic' },
  { label: 'TH Classico', value: 'TH Classico' },
  ...
  { label: 'Techno Progressive', value: 'Techno Progressive' },
  { label: 'Techno', value: 'Techno' },
  { label: 'Techno Poucas', value: 'Techno Poucas' },
  { label: 'Techno Hard', value: 'Techno Hard' },
  ...
  { label: 'House Relax', value: 'House Relax' },
...
const SONG_STYLES_COLOR_MAP = {  
  ...
  'TH Housy': { backgroundColor: '#dbbe18', color: '#fff' },
  'TH Ethnic': { backgroundColor: '#cc8862', color: '#fff' },
  'TH Classico': { backgroundColor: '#c94b14', color: '#fff' },
  'TH Serious': { backgroundColor: '#a84107', color: '#fff' },
  'TH Dance Bangers': { backgroundColor: '#e87533', color: '#fff' },
  'Deep House': { backgroundColor: '#95a4ed', color: '#fff' },
  'Progressive': { backgroundColor: '#487af0', color: '#fff' },
  'Ethnic': { backgroundColor: '#57279c', color: '#fff' },
  'Techno Progressive': { backgroundColor: '#8e8a94', color: '#fff' },
  'Techno': { backgroundColor: '#534c5c', color: '#fff' },
  'Techno Poucas': { backgroundColor: '#312b38', color: '#fff' },
  'Techno Hard': { backgroundColor: '#37343b', color: '#fff' },
  ...
  'Deep Tech': { backgroundColor: '#a384a3', color: '#fff' },
  'House Relax': { backgroundColor: '#bd73bd', color: '#fff' },
